...
class TestDjangoTableForm001(DPage):
    """ Django table form support """
    title = 'Django table form support 001'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
    ...
    def get(self, request, *args, **kwargs):
        reset = LNKSPrimary('/dpages/TestDjangoTableForm001', 'Reset')
        form = Form(request,
                    self.NameForm(initial={'name': 'Enter your name here'}),
                    'table',
                    'Fire phasers')
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            content = page_content(self, self.code, content)
            return self.render(request, content)
        form = Form(request, form, 'table', 'Fire photon torpedoes')
        content = RC((reset, form))
        content = page_content(self, self.code, content)
        return self.render(request, content)


class TestDjangoTableForm002(DPage):
    """ Django table form support """
    title = 'Django table form support 002'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
    ...
    def get(self, request, *args, **kwargs):
        ...
        for f in form.fields:
            print f
        reset = LNKSPrimary('/dpages/TestDjangoTableForm002', 'Reset')
        form = Form(request, form, 'table', 'Fire phasers', '/dpages/TestDjangoTableForm002')
        content = RC((reset, form))
        content = page_content(self, self.code, content)
        return self.render(request, content)
...
class TestForm(forms.Form):
    ...
    char_hidden_field = forms.CharField(widget=forms.HiddenInput)
    textarea_field = forms.CharField(widget=forms.Textarea)
    choice_field = forms.ChoiceField(choices=YEAR_IN_SCHOOL_CHOICES)
    choice_radio_select_field = forms.ChoiceField(choices=YEAR_IN_SCHOOL_CHOICES,
                                                  widget=forms.RadioSelect)
    date_field = forms.DateField()
    date_widget_field = forms.DateField(widget=forms.DateInput)
    date_select_widget_field = forms.DateField(widget=SelectDateWidget)
    date_time_field = forms.DateTimeField()
    date_time_select_field = forms.DateTimeField(widget=forms.SplitDateTimeWidget)
    decimal_field = forms.DecimalField()
    email_field = forms.EmailField()
    file_field = forms.FileField()
    file_input_field = forms.FileField(widget=forms.FileInput)
    ...
    multiple_choice_checkbox_field = forms.MultipleChoiceField(choices=YEAR_IN_SCHOOL_CHOICES,
    ...
    # todo 2: ComboField, MultiVlaueField, SplitDateTimeField, ModelChoiceField, ModelMultipleChoiceField
...
def test_bform_get(dpage_obj, request, form_type, width_label=None, width_field=None, layout=None):
    ...
    form = Form(request, TestForm(), form_type)
    if width_label:
...
class TestFormTable(DPage):
    """ Form table form support """
    title = 'Form table support'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
...
class TestFormParagraph(DPage):
    """ Form paragraph form support """
    title = 'Form paragraph support'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
...
class TestFormUL(DPage):
    """ form UL form support """
    title = 'Form UL support'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
...
class TestFormBootstrap(DPage):
    """ Bootstrap default form support """
    title = 'Bootstrap form support'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
...
class TestFormBootstrapHorizontal(DPage):
    """ Bootstrap horizontal form support """
    title = 'Bootstrap horizontal form support'
    description = 'Demonstrate ' + title
    tags = ['test', 'forms']
